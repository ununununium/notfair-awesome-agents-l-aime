...
| [toprank](https://github.com/nowork-studio/toprank) | Open-source Claude Code plugin with 9 SEO and Google Ads skills — connects Google Search Console, PageSpeed Insights, and Google Ads API | TypeScript | 200+ | 2025 |
...
| Project | Description | Language | Stars | Last Updated |
|---------|-------------|----------|-------|--------------|
| [Claude](https://claude.ai/) | AI assistant by Anthropic | - | - | 2024 |
...
| Project | Description | Language | Stars | Last Updated |
|---------|-------------|----------|-------|--------------|
| [Browser-Use](https://github.com/browser-use/browser-use) | 🌐 Make websites accessible for AI agents. Automate tasks online with ease | Python | 67k+ | 2024 |
| [AgenticSeek](https://github.com/Fosowl/agenticSeek) | Fully Local Manus AI. No APIs, No $200 monthly bills | Python | 20k+ | 2024 |
...
| Tool | Description | Language | Stars | Last Updated |
|------|-------------|----------|-------|--------------|
| [Langflow](https://github.com/logspace-ai/langflow) | UI for LangChain, designed with react-flow | Python | 15k+ | 2024 |
| [n8n](https://github.com/n8n-io/n8n) | Workflow automation tool | TypeScript | 40k+ | 2024 |
| [Zapier](https://zapier.com/) | Connect your apps and automate workflows | - | - | 2024 |
